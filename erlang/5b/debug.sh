...
kafka() {
  ...
  # {"body":{"key":["k1",1001],"msg_id":13,"type":"read"},"dest":"seq-kv","src":"n1"}
  printf "%s\n" '{"src":"seq-kv","dest":"n1","body":{"in_reply_to":13,"type":"read_ok","value":5}}'
  # {"body":{"key":["k1",1002],"msg_id":14,"type":"read"},"dest":"seq-kv","src":"n1"}
  printf "%s\n" '{"src":"seq-kv","dest":"n1","body":{"in_reply_to":14,"type":"error","code":20}}'
  # {"body":{"key":["k2",2000],"msg_id":15,"type":"read"},"dest":"seq-kv","src":"n1"}
  printf "%s\n" '{"src":"seq-kv","dest":"n1","body":{"in_reply_to":15,"type":"read_ok","value":7}}'
  # {"body":{"key":["k2",2001],"msg_id":16,"type":"read"},"dest":"seq-kv","src":"n1"}
  printf "%s\n" '{"src":"seq-kv","dest":"n1","body":{"in_reply_to":16,"type":"read_ok","value":2}}'
  # {"body":{"key":["k2",2002],"msg_id":17,"type":"read"},"dest":"seq-kv","src":"n1"}

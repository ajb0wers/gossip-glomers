...
kafka() {
  ...
  send '{"src":"seq-kv","dest":"n1","body":{"in_reply_to":8,"type":"read_ok","value":5}}'
  send '{"src":"seq-kv","dest":"n1","body":{"in_reply_to":9,"type":"read_ok","value":7}}'
  send '{"src":"seq-kv","dest":"n1","body":{"in_reply_to":10,"type":"read_ok","value":2}}'
  send '{"src":"seq-kv","dest":"n1","body":{"in_reply_to":11,"type":"error","code":20}}'
  ...
  send '{"src":"n0","dest":"n1","body":{"in_reply_to":12,"type":"commit_offsets_ok"}}'
  # {"body":{"key":["commit_offset","k1"],"msg_id":13,"type":"read"},"dest":"lin-kv","src":"n1"}
  send '{"src":"lin-kv","dest":"n1","body":{"in_reply_to":13,"type":"read_ok","value":0}}'
  ...
  send '{"src":"lin-kv","dest":"n1","body":{"in_reply_to":16,"type":"read_ok","value":2000}}'

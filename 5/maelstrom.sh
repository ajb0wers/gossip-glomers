...
kafka() {
  ...
  printf "%s\n" '{"src":"c1","dest":"n1","body":{"type":"commit_offsets","offsets":{"k1":1,"k2":2}}}'
  printf "%s\n" '{"src":"c1","dest":"n1","body":{"type":"last_commited_offsets","keys":["k1","k2"]}}'
  printf "%s\n" '{"src":"c1","dest":"n1","body":{"type":"poll","offsets":{"k1":2,"k2":2}}}'
  cat -
} 
